...
В пакете **нет CSS**. Скопируй стили из исходного приложения (Gaiduk) или напиши свои под BEM-классы движка.
...
## 17. Шаблон для копирования в новый репозиторий
...
## 18. Промпт для AI-агента (копипаст)
